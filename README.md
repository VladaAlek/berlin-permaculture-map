...
- [W3C Markup Validator](https://validator.w3.org/ "W3C Markup Validator") - results
- [W3C CSS Validator](https://jigsaw.w3.org/css-validator/#validate_by_input "W3C CSS Validator") - results

Trailing slashes in the void elements were autogenerated by the Codeanywhere code editor and automatically restored after being erased by me. Markup Validator indicates them as WARNING. However, their presence is [optional](https://rocketvalidator.com/html-validation/trailing-slash-on-void-elements-has-no-effect-and-interacts-badly-with-unquoted-attribute-values "optional") according to some validation postulates.
...
-The project was design for the following screen sizes: smartphone (375 x 700px); iPad (768 x 1024) and 1024 x 700px. The website was viewed and responsiveness controlled on a variety of devices of various screen sizes (smartphone, tablet, 1024px).
-Extensive testing was conducted to verify correct linking across all pages.

## Known Bugs
The "CONTRIBUTE!" button might not function properly due to interference from an iframe.
